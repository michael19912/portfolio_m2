            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">charleswest552@yahoo.com
 
</span>
                  <button
                    title="Copy email address"
                    onClick={() => copyToClipboard('charleswest552@yahoo.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+1 615 803 5399</span>
                  <button
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Nashville, Tennessee, United States</span>
                </div>
              </div>
            </motion.div>
